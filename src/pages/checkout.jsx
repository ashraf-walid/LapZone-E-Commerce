...
import { generateOrderNumber, shippingOptions, paymentMethods } from '../components/constant'
import InputField from '../components/checkoutPage/InputField';
import { validateForm } from '../utils/validation';

export default function Checkout() {
  const { cartItem, cartProducts, subtotal, clearCart, currentUser, signInWithGoogle } = useContext(ShopContext);
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <ApplyCoupon setCouponCode={setCouponCode} couponCode={couponCode} discount={discount} setDiscount={setDiscount} isLoading={isLoading} setIsLoading={setIsLoading}/>
              ...
              <div className="mt-6">
                <label className="flex items-center gap-2 cursor-pointer">
                  ...
                  <span className="text-sm text-gray-600">
                    I agree to the{' '}
                    <Link to="/TermsAndConditions" className="text-blue-500 hover:underline">
                      Terms and Conditions
                    </Link>{' '}
                      and{' '}
                    <Link to="/ReturnsPolicy" className="text-blue-500 hover:underline">
                      Privacy Policy
                    </Link>
                  </span>
                </label>
              ...
              <button
                ...
                disabled={!acceptedTerms || !currentUser || cartProducts.length === 0}
                className={`w-full mt-6 py-3 rounded-lg text-white font-semibold transition-colors ${
                  acceptedTerms && currentUser && cartProducts.length > 0
