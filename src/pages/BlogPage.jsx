  ...
  const blogPosts = [
    {
      ...
      date: "January 2, 2025",
      excerpt: "Discover the key factors to consider when selecting a gaming laptop, from GPU performance to cooling systems...",
      readTime: "5 min read"
    },
    {
      id: 2,
      ...
      date: "January 4, 2025",
      excerpt: "Find the perfect mechanical keyboard to enhance your coding experience with our comprehensive guide...",
      readTime: "4 min read"
    },
    {
      id: 3,
      ...
      date: "January 5, 2025",
      excerpt: "Learn essential maintenance practices to keep your laptop running smoothly and extend its lifespan...",
      readTime: "6 min read"
    }
  ];
    ...
    <div className="container mx-auto px-4 py-8 bg-gray-50">
      ...
      <div className="max-w-6xl mx-auto mb-8">
        <div className="flex flex-wrap justify-center gap-4">
          ...
          <button className="px-6 py-2 bg-white text-gray-700 rounded-full hover:bg-gray-100">
            Buying Guides
          </button>
          <button className="px-6 py-2 bg-white text-gray-700 rounded-full hover:bg-gray-100">
            Reviews
          ...
          <div className="md:flex">
            ...
            <div className="p-8">
              ...
              <p className="mt-4 text-gray-600">
                Understanding laptop specifications doesn't have to be complicated. In this comprehensive guide, we break down every important specification you need to know before making your purchase...
              </p>
              <div className="mt-6">
