    ...
    <div className="inline-flex items-center">
      <select
        ...
        onChange={(e) => onChange(e.target.value)}
          className={`${config.bg} ${config.color} ${config.border} text-sm sm:text-base rounded-full px-2 sm:px-3 py-1 border 
      ...
      <StatusIcon className={`${config.color} w-4 h-4 ml-2`} />
    </div>
  );
}
